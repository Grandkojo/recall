...
/* Square corners, bold weight — no rounding anywhere. */
const BASE =
  'inline-flex items-center justify-center gap-2 font-semibold tracking-tight leading-none transition-colors duration-150 cursor-pointer select-none outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed';
